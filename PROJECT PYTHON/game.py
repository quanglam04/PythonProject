...
class TankGame:
    def __init__(self, window_width, window_height):
        ...
        self.tank = Tank("C:/Users/84334/Desktop/branchme/PythonProject/PROJECT PYTHON/asset/Blue Tank.png", window_width, window_height)# day goi ra class Tank o tank.py
    ...
    def run(self, window):
        ...
        image = pygame.image.load('C:/Users/84334/Desktop/branchme/PythonProject/PROJECT PYTHON/asset/battlefield.png') #load background
        ...
        while self.running:
            ...
            # Di chuyển và loại bỏ đạn nếu ra khỏi màn hình
